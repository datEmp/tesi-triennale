...
\lstdefinelanguage{JavaScript}{
  morekeywords=[1]{break, continue, delete, else, for, function, if, in,
    new, return, this, typeof, var, void, while, with, render, getElementById, width, height, contract, address, event, uint256, public, returns, emit, pragma},
  ...
  morekeywords=[4]{React, ., Component, Saluto, Convenevoli, Contatore, setContatore, useState, contatore,
    ...
    activeStep, setActiveStep, web3Instance, userAccount, fetchCoins, setLoadingCoinList, newCoinsList},
  morekeywords=[5]{},
  sensitive,
  morecomment=[s]{/*}{*/},
  morecomment=[l]//,
    ...
    \begin{lstlisting}[style=ES6, title={Esempio renderizzazione componente}]
      ...
      \begin{lstlisting}[style=ES6, title={Esempio uso di useEffect()}]
        ...
        \begin{itemize}
          ...
          \item \verb|truffle deploy|, per eseguire il deploy degli smart contracts\cite{truffle}.
        \end{itemize}
        \newpage
        ...
        \newline
        \verb|activeStep| è un intero che indica lo step corrente.
        \newline
        ...
        la stringa viene, quindi, convertita in caratteri minuscoli ed assegnata alla variabile \verb|searchInput|. Alla riga 4 viene chiamata la funzione filter sull'array \verb|coinsList|,
        ...
        Una volta terminata la funzione di filtro si ha quindi una lista contenete solo monete che includono il termine di ricerca. Questa lista viene, quindi, assegnata alla variabile di stato \verb|activeCoinsList| usando,
