...
export const saleCreate = async (web3, sellerAddress, coinsOnSaleAddr, amountsOnSale, coinsToAcceptAddr, amountsToAccept, expirationDate) => {
  try {
    ...
    return false;
        ...
        \newline
        Ottenuto l'istanza di \verb|SaleFactory|, si può creare la vendita. Questo è realizzato chiamando alla riga 20 il metodo \verb|SaleFactoryInstance.methods.createSale()|, passando come parametri le opzioni della vendita,
        ...
        \begin{itemize}
          \item Nel primo step l'utente sceglie i token in suo \verb||\verb||sesso da mettere in vendita;
