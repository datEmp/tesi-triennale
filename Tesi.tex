...
const fetchSales = async () => {
  ...
  setLoadingSaleList(false);
        ...
        Questa funzione genera inizialmente una variabile \verb|boolean| \verb|ownerHasExpiredSales| inzializzata a false, e tre array: \verb|onGoingSales|, \verb|endedSales| e \verb|expiredSales|.
        ...
        \begin{figure}[H]
          ...
          \centering
          \caption{Pop-up mostrato se l'utente ha venite scadute}
          \centering
          \label{fig:Pop-up}
        \end{figure}
